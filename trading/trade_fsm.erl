...
%%the other side has accepted, let's move on
...
negotiate(are_you_ready, S=#state{other=OtherPid}) ->
  ...
  notice(S, "other player ready to transfer goods:~n"
...
%%determining the priority for electing the 2-phase commit leader based on strict ordering of the Pids offered by Erlang
...
%%this comes from the client, must tell the other player
